import {MarkdownSlides} from "spectacle"

{/* INTRO - Old way */}
<Slide transition={['slide']} bgColor="tertiary" notes="@TODO">
    <Heading caps size={6} textColor="primary">
        How we use to do ?
    </Heading>
    <Heading size={4} textColor="secondary" margin="20px 0px 0px">
        Build "pages" or "screens"
    </Heading>
